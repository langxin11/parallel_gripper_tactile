"""兼容入口：请从 ``parallel_gripper_tactile.perception.slip`` 导入，将于 0.4.0 移除。"""
...
warnings.warn(
    "parallel_gripper_tactile.tactile_slip 已弃用，将于 0.4.0 移除；"
    "请改用 parallel_gripper_tactile.perception.slip。",
    DeprecationWarning,
    stacklevel=2,
)

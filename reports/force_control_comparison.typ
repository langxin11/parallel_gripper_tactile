...
#show: ieee.with(
  title: [自研平行夹爪法向力控制：控制律、离散约束与验证边界],
  authors: (
    (name: "肖大亮", organization: "北京理工大学空天学院", email: "2658327508@qq.com"),
  ),
  abstract: [本文梳理自研平行夹爪当前实现的法向力控制方法，包括位置式 PID、历史刚度位置前馈、刚度感知位置增量限幅、DMgripper 二阶导纳及二阶直接力矩 ADRC。重点给出统一运动学、离散控制律和实验比较边界。现有证据只支持实现状态与验证范围说明；新限幅参数尚未完成多任务、多随机种子整定。],
